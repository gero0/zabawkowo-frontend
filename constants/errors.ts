const ErrorMap = {
  ...
  "ERR_OFFER_PRICE" : "Podana cena nie jest prawidłowa, upewnij się, że format jest właściwy",
  ...
  "ERR_UPLOAD_FAILED" : "Nie udało się wysłać pliku. Możliwe, że format jest niewspierany (akceptujemy jpg, png i gif)",
  "ERR_FETCHING_CATEGORIES" : "Nie udało się wczytać kategorii. Baza danych się obraziła i nie działa, pracujemy nad tym",
  ...
  "ERR_ADDING_ADDRESS" : "Nie udało się dodać adresu. Zespół studentów został wysłany do zbadania problemu",
  ...
  "ERR_TOKEN_LOCAL" : "Błąd tokena. Spróbuj ponownie się zalogować"
};
